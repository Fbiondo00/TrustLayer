...
import type { EmbeddingService as EmbeddingServiceInterface } from "@/lib/schema";

// Re-exported here so consumers can `import { EmbeddedChunk } from "@/lib/core"`.
export type { EmbeddedChunk } from "@/lib/schema";
