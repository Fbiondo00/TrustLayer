 ...
 * `@trustlayer/schema` / `./embeddings.js` to `@/lib/schema` / `./embeddings`.
 */

import { readFileSync, readdirSync, statSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import type { RAGResult, RAGService as RAGServiceInterface } from "@/lib/schema";
import type { EmbeddedChunk } from "@/lib/schema";
