...
import type { ApprovalReport } from "@/lib/schema";
import type { Finding, PermissionReport, TXReport, TrustScore } from "@/lib/schema";
import type { ComponentScores } from "@/lib/schema";
